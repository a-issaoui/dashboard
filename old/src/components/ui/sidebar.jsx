        ...
        return (
            <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
                <SheetContent
                    ...
                    data-mobile="true"
                    className={cn(
                        "bg-sidebar text-sidebar-foreground p-0 border-0",
                        "w-[var(--sidebar-width-mobile)] max-w-[85vw]",
                        "[&>button[data-sheet-close]]:hidden"
                    )}
                    style={{
        ...
        >
            ...
            <div
                ...
                className={cn(
                    ...
                    "group-data-[side=left]:group-data-[collapsible=offcanvas]:-left-[var(--sidebar-width)]",

                    // Right side positioning
                    "group-data-[side=right]:right-0",
                    "group-data-[side=right]:group-data-[collapsible=offcanvas]:-right-[var(--sidebar-width)]",
    ...
    return (
        <button
            ...
            className={cn(
                ...
                // Cursor styles
                "group-data-[state=expanded]:group-data-[side=left]:cursor-w-resize",
                "group-data-[state=expanded]:group-data-[side=right]:cursor-e-resize",
    ...
    return (
        <main
            ...
            className={cn(
                ...
                "md:peer-data-[variant=inset]:ps-0 md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ps-2",
                className
            )}
            {...props} />
    );
