// src/components/layouts/admin/sidebar/NavigationMenu.tsx
'use client';
...
const MenuItemRenderer = memo<MenuItemRendererProps>(({
                                                          item,
                                                          pathname,
                                                          level = 0,
                                                          isActiveTree = false
...
const NavigationGroup = memo<NavigationGroupProps>(({ group, pathname }) => {
    const t = useTranslations();
    const { state } = useSidebar();
    const isCollapsed = state === 'collapsed';
